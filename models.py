...
class User(Base):
    ...
    # Numéro de matricule (pour les étudiants)
    ...
    # Classes dont l'enseignant est responsable
...
# ══════════════════════════════════════════════════════
#  CLASSES (ClassGroup)
#  Représente une promotion/classe : ex "L1 Informatique 2024-2025"
# ══════════════════════════════════════════════════════

class ClassGroup(Base):
    __tablename__ = "class_groups"
    id               = Column(Integer, primary_key=True, index=True)
    name             = Column(String(100), nullable=False)    # ex: "L1 Informatique"
    code             = Column(String(20),  nullable=True)     # ex: "L1-INFO"
    description      = Column(Text,        nullable=True)
    level            = Column(String(50),  nullable=True)     # ex: "Licence 1", "Master 2"
    academic_year_id = Column(Integer, ForeignKey("academic_years.id"), nullable=True)
    teacher_id       = Column(Integer, ForeignKey("users.id"), nullable=True)  # enseignant responsable
...
class Course(Base):
    ...
    class_group_id= Column(Integer, ForeignKey("class_groups.id"), nullable=True)  # ← lié à une classe
